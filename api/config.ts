...
Issue #${issueNumber} isn't approved for implementation yet. This PR won't be tracked until it is.${SIGNATURE}`,
...
Issue #${issueNumber} is ready for implementation, but this PR was opened before the issue reached that state and was not automatically activated for implementation tracking.
